	 ...
	 CREATE TABLE lacznik (
	 id_pracownika INT(5) NOT NULL auto_increment,
	 id_zadania INT(5) NOT NULL,
	 PRIMARY KEY(id_pracownika , id_zadania))CHARSET=utf8;
	...
	ALTER TABLE projekty
        ADD INDEX id_zadania (id_zadania),
	ADD FOREIGN KEY (id_zadania) references zadania (id_zadania) ON DELETE NO ACTION;
	
	ALTER TABLE zadania
        ADD INDEX id_kategoria (id_kategorii),
	ADD FOREIGN KEY (id_kategorii) references kategoria (id_kategorii) ON DELETE NO ACTION;
        
	ALTER TABLE lacznik
        ADD INDEX id_pracownika (id_pracownika),
	ADD INDEX id_zadania (id_zadania),
	ADD FOREIGN KEY (id_pracownika) references pracownicy (id_pracownika) ON DELETE NO ACTION,
	ADD FOREIGN KEY (id_zadania) references zadania (id_zadania) ON DELETE NO ACTION;
